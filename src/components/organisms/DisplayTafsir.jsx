function DisplayTafsir({ ayah="", tafsir="" }) {
  return (
    <div>
      <div className="bg-gray-100 text-main-100 font-scheherazade font-bold text-xl leading-[3.2rem] lg:text-2xl p-4 mx-auto max-w-xl text-center rounded-2xl shadow">
        {ayah}
      </div>
      <svg
        className="mx-auto w-16 my-14 -rotate-90"
        ...
        <defs>
          <clipPath id="clip0_130_190">
            <rect
              ...
              height="10"
              fill="white"
              transform="translate(69.1562 10) rotate(179.81)"
            />
          </clipPath>
        </defs>
      </svg>
      <div className="bg-gray-100 text-main-100 font-bold text-xl lg:text-lg leading-relaxed p-4 mx-auto max-w-3xl text-center rounded-2xl shadow">
        {tafsir}
      </div>
    </div>
  );
